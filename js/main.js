...
$(document).ready(function(){
	...
	polygon0 = paper.path("M360 0 L121 53 L121 158 L211 278 L360 208 L360 70 L360 0").attr({fill:'#fff',stroke:'none',opacity:'0',cursor:'pointer'});  
	polygon1 = paper.path("M270 0 L120 70 L120 208 L240 278 L360 208 L360 70 L270 0").attr({fill:'#fff',stroke:'none',opacity:'0',cursor:'pointer'});
	polygon2 = paper.path("M450 0 L361 70 L361 208 L481 278 L601 208 L601 70 L450 0").attr({fill:'#fff',stroke:'none',opacity:'0',cursor:'pointer'});
	polygon3 = paper.path("M180 270 L90 279 L90 417 L180 487 L270 417 L270 279 L180 270").attr({fill:'#fff',stroke:'none',opacity:'0',cursor:'pointer'});
	polygon4 = paper.path("M360 270 L270 279 L270 417 L360 487 L450 417 L450 279 L360 270").attr({fill:'#fff',stroke:'none',opacity:'0',cursor:'pointer'});
	polygon5 = paper.path("M540 270 L450 279 L450 417 L540 487 L630 417 L630 279 L540 270").attr({fill:'#fff',stroke:'none',opacity:'0',cursor:'pointer'});
	
	polygon0.hover(function(){home_hover_show('why_hover_0');},function(){home_hover_hide('why_hover_0');});
...
polygon0.click(function(){move_to_services(2);});	
...
/*IIC
	function home_hover_show(name){
		...
		$('#container .'+name+' .upper_side').stop().animate({opacity:'1',width:'90px'},250);
		$('#container .'+name+' .lower_side').stop().animate({opacity:'1',width:'90px'},250,function(){
...
*/
	function home_hover_show(name){
		$('#container .'+name+' .home_title').css('text-decoration','underline');
		$('#container .'+name+' .left_side').stop().animate({opacity:'1',width:'90px'},250);
		$('#container .'+name+' .right_side').stop().animate({opacity:'1',width:'90px'},250,function(){
			$('#container .'+name+' .text').stop().animate({opacity:'1'},250);
		});
	}
