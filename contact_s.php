...
<script type="text/javascript">
	$(document).ready(function(){
				var page_block = 'block_5';						block_nr_position = $('#container2 .'+page_block).position();
...
<div class="clear"></div></div></div>
				<div class="career"><div class="towers"></div><div class="corner"></div><div class="content ins"><h1>Special Offer</h1><h2><p>First 15 registrations get a special discount of 50%.</p></h2><br>
<br>
<h3><a href="generalrules.pdf">General Rules</a></h3>
<div class="clear"></div></div></div>
				<div class="clear"></div>
			</div>
		</div>
